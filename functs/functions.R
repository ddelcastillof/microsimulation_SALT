#-------------------------------------------------------------------------------------------
# Modeling functions
# Adapted from Kennedy-Shaffer et al. 2019 at git@github.com/leekshaffer/SW-CRT-analysis.git
#-------------------------------------------------------------------------------------------

# Loading packages
if (!require(pacman)) install.packages("pacman")                                                                                                                                                                                                      
pacman::p_load(MASS, Synth, lme4)

# SC-SWT Functions

source(here::here("functions", "helpers.R"))
